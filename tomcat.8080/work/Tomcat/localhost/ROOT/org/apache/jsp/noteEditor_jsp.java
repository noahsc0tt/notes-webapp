 ...
 * Generated at: 2025-03-17 22:12:16 UTC
...
public final class noteEditor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <script>\n");
      out.write("      function insertLink() {\n");
      out.write("          const url = prompt(\"Enter URL:\", \"https://\");\n");
      out.write("          const text = prompt(\"Enter link text:\", \"Link Text\");\n");
      out.write("          if (url && text) {\n");
      out.write("              const textarea = document.getElementsByName(\"body\")[0];\n");
      out.write("              const startPos = textarea.selectionStart;\n");
      out.write("              const endPos = textarea.selectionEnd;\n");
      out.write("              const beforeText = textarea.value.substring(0, startPos);\n");
      out.write("              const afterText = textarea.value.substring(endPos, textarea.value.length);\n");
      out.write("              textarea.value = beforeText + \"[\" + text + \"](\" + url + \")\" + afterText;\n");
      out.write("              textarea.focus();\n");
      out.write("          }\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      function insertImage() {\n");
      out.write("          const url = prompt(\"Enter image URL:\", \"https://\");\n");
      out.write("          const alt = prompt(\"Enter image description:\", \"Image\");\n");
      out.write("          if (url) {\n");
      out.write("              const textarea = document.getElementsByName(\"body\")[0];\n");
      out.write("              const startPos = textarea.selectionStart;\n");
      out.write("              const endPos = textarea.selectionEnd;\n");
      out.write("              const beforeText = textarea.value.substring(0, startPos);\n");
      out.write("              const afterText = textarea.value.substring(endPos, textarea.value.length);\n");
      out.write("              textarea.value = beforeText + \"![\" + alt + \"](\" + url + \")\" + afterText;\n");
      out.write("              textarea.focus();\n");
      out.write("          }\n");
      out.write("      }\n");
      out.write("    </script>\n");
    ...
    request.setAttribute("title", title);
      ...
      out.write(" Note</h1>\n");
      out.write("\n");
      out.write("  <form action=\"/save_note\" method=\"POST\">\n");
      out.write("      Note Name:\n");
      ...
      out.write("\"><br>\n");
      out.write("      Note Body:\n");
      out.write("      <textarea name=\"body\" rows=\"20\" columns=\"40\" style=\"font-family: inherit;\">");
      ...
      out.write("      <button type=\"button\" onclick=\"insertImage()\">Insert Image</button><br>\n");
